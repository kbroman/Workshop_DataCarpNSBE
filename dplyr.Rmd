...
> **Challenge**: Look at the help file for `tail()` and figure out how to look at the last 20 rows.
...
> **Challenge**: What is the average GDP per cap (`gdpPercap`) by continent?

You can use `group_by` with multiple columns, for example the average GDP per capita by continent and by year.
...
> **Challenge**: Calculate the overall GDP per capita by continent in the year 1952 and 2007.
>
