...
the points colored by country. We might try this:
...
library(wesanderson)
p + scale_color_manual(values=wes_palette("Darjeeling1"))
```
...
tick marks and add a black border. You get this with `theme_karl()` in
my [broman](https://github.com/kbroman/broman) package. Install it as
follows.
